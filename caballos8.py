                                                                                    ...
                                                                                    for x22 in range(10):
                                                                                        for x23 in range(10):
                                                                                            for x24 in range(10):
                                                                                                ...
                                                                                                x31=my_function(x1,efef,15,16)
                                                                                                x32=my_function(x1,efef,16,17)
                                                                                                x33=my_function(x1,efef,17,18)
                                                                                                x34=my_function(x1,efef,18,19)
                                                                                                x35=my_function(x1,efef,19,20)
                                                                                                x36=my_function(x1,efef,20,21)
                                                                                                x37=my_function(x1,efef,21,22)
                                                                                                x38=my_function(x1,efef,22,23)

                                                                                                if x2==1 and x22==1 and x222==1 and x2222==1 and x22222==1 and x21==1 and x22==1 and x23==1 and x24==1 and x25==1 and x26==1 and x27==1 and x28==1 and x29==1 and x30==1 and x31==1 and x32==1 and x33==1 and x34==1 and x35==1 and x36==1 and x37==1 and x38==1:
                                                                                                    total = total+1
